# Family Zoo — v06 — Openable Things — Claude Project Memory
...
**Name:** Family Zoo — v06 — Openable Things
**Purpose:** Sharpee tutorial step 6 — Openable Things.
...
**Repository:** https://github.com/Johnesco/familyzoo-v06
**Live:** https://johnesco.github.io/familyzoo-v06/
...
├── familyzoo-06.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v06.story`.
